package com.osiris.jgbrowser.utils;
...
public class Utils {
     ...
     */
    public InputStream getFileFromThisJar(String filePathInJar) throws Exception {
     ...
     */
    public String getFileContentFromThisJar(String filePathInJar) throws Exception {
     ...
     * @return the files {@link InputStream}.
     */
    public InputStream getFileFromJar(String filePathInJar, String pathOfJar) throws FileNotFoundException, MalformedURLException {
